...
const Listitem = ({ item, handleClientConnectClick, handleLaborerConnectClick, clientLoggedIn, laborerLoggedIn,laborerId}) => {
        ...
        try {
          ...
          if (laborerId) {
            ...
            if (response.data.reviews.length > 0) {
              ...
              const average = totalRating / response.data.reviews.length;
